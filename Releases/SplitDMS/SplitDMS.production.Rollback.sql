PRINT N'Dropping [dbo].[CampaignAllPackagesSent]...'; 

GO 

DROP PROCEDURE [dbo].[CampaignAllPackagesSent]; 

GO 

PRINT N'Dropping [dbo].[CampaignSplitedUpdate]...'; 

GO 

DROP PROCEDURE [dbo].[CampaignSplitedUpdate]; 

GO 

PRINT N'Dropping [dbo].[UpdatePackageSubscribersAsSent]...'; 

GO 

DROP PROCEDURE [dbo].[UpdatePackageSubscribersAsSent]; 

GO 

PRINT N'Dropping [dbo].[TypeCampaignDeliveriesUpdate]...'; 

GO 

DROP TYPE [dbo].[TypeCampaignDeliveriesUpdate]; 
...
ALTER TABLE [dbo].[Campaign] 
  DROP COLUMN [DMSSplited], COLUMN [UTCDMSLastUpdate]; 
